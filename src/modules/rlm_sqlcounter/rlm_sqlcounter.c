...
{
	// make sure you add this at the very end of accouting section
	// This does not take into account if the time is close to reset period
	...
	if (limit->vp_integer64 <= counter)
	{
		...
		// Hard code Attribute Value to 0
		reply_item->vp_integer64 = 0;
